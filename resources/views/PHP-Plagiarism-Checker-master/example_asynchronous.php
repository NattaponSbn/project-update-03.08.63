...
//   "key": "B423E4CB-30E4-4B4A-BC3F-1A30D063BA9A"
// }';
...
$email = '60020637@up.ac.th';
$apiKey = 'B423E4CB-30E4-4B4A-BC3F-1A30D063BA9A';
...
try{
	...
	$additionalHeaders = array($clConst['SANDBOX_MODE_HEADER'], // Sandbox mode - Scan without consuming any credits and get back dummy results
                                $clConst['HTTP_CALLBACK'].': https://postman-echo.com/post' # For a fast testing of callbacks option we recommend to use http://requestb.in
	...
	$process  = $clCloud->createByURL("https://api.copyleaks.com/academicdocumentation", $additionalHeaders);
